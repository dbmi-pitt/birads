 ...
 * @generated */
public class SeverityModifier extends Modifier {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SeverityModifier.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SeverityModifier() {/* intentionally empty block */}
   ...
   */
  public SeverityModifier(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public SeverityModifier(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public SeverityModifier(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
