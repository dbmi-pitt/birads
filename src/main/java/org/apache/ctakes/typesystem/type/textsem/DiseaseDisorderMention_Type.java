...
public class DiseaseDisorderMention_Type extends EventMention_Type {
  ...
  public final static int typeIndexID = DiseaseDisorderMention.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getAlleviatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("alleviatingFactor", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getAssociatedSignSymptom(int addr) {
      ...
      jcas.throwFeatMissing("associatedSignSymptom", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getBodyLaterality(int addr) {
      ...
      jcas.throwFeatMissing("bodyLaterality", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getBodySide(int addr) {
      ...
      jcas.throwFeatMissing("bodySide", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getBodyLocation(int addr) {
      ...
      jcas.throwFeatMissing("bodyLocation", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getCourse(int addr) {
      ...
      jcas.throwFeatMissing("course", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getDuration(int addr) {
      ...
      jcas.throwFeatMissing("duration", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getExacerbatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("exacerbatingFactor", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
  ...
  public int getRelativeTemporalContext(int addr) {
      ...
      jcas.throwFeatMissing("relativeTemporalContext", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
   ...
   * @return the feature value 
   */ 
  public int getSeverity(int addr) {
        if (featOkTst && casFeat_severity == null)
      jcas.throwFeatMissing("severity", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
    return ll_cas.ll_getRefValue(addr, casFeatCode_severity);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setSeverity(int addr, int v) {
        if (featOkTst && casFeat_severity == null)
      jcas.throwFeatMissing("severity", "org.apache.ctakes.typesystem.type.textsem.DiseaseDisorderMention");
    ll_cas.ll_setRefValue(addr, casFeatCode_severity, v);}
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public DiseaseDisorderMention_Type(JCas jcas, Type casType) {
    super(jcas, casType);
    casImpl.getFSClassRegistry().addGeneratorForType((TypeImpl)this.casType, getFSGenerator());

 
    casFeat_alleviatingFactor = jcas.getRequiredFeatureDE(casType, "alleviatingFactor", "org.apache.ctakes.typesystem.type.relation.ManagesTreatsTextRelation", featOkTst);
    ...
    casFeat_associatedSignSymptom = jcas.getRequiredFeatureDE(casType, "associatedSignSymptom", "org.apache.ctakes.typesystem.type.relation.ManifestationOfTextRelation", featOkTst);
    ...
    casFeat_course = jcas.getRequiredFeatureDE(casType, "course", "org.apache.ctakes.typesystem.type.relation.DegreeOfTextRelation", featOkTst);
    ...
    casFeat_exacerbatingFactor = jcas.getRequiredFeatureDE(casType, "exacerbatingFactor", "org.apache.ctakes.typesystem.type.relation.ComplicatesDisruptsTextRelation", featOkTst);
    ...
    casFeat_severity = jcas.getRequiredFeatureDE(casType, "severity", "org.apache.ctakes.typesystem.type.relation.DegreeOfTextRelation", featOkTst);
