...
public class CausesBringsAboutTextRelation extends BinaryTextRelation {
  ...
  public final static int typeIndexID = JCasRegistry.register(CausesBringsAboutTextRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CausesBringsAboutTextRelation() {/* intentionally empty block */}
   ...
   */
  public CausesBringsAboutTextRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
