...
public class BiradsDataSourceManager {
	...
	private String hibernateConnectionUrl = "jdbc:mysql://localhost:3306/birads_prime";;
	...
	private void addAnnotatedClasses() {
		configuration.addAnnotatedClass(edu.pitt.dbmi.birads.brokprime.pojos.Report.class);
		configuration.addAnnotatedClass(edu.pitt.dbmi.birads.brokprime.pojos.Statistics.class);
	}
