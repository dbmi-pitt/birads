 ...
 * @generated */
public class NoBirads extends Birads {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NoBirads.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NoBirads() {/* intentionally empty block */}
   ...
   */
  public NoBirads(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public NoBirads(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
